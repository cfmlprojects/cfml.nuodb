...
<cfcomponent>
	...
	<cffunction name="getPosts" access="public" returntype="Post[]" output="false">
		<cfreturn entityLoad('Post',{},'published desc') />
	</cffunction>
	
	<cffunction name="getPost" access="public" returntype="Post[]" output="false">
	...
	<cffunction name="savePost" access="public" returntype="void" output="false">
		<cfargument name="post" type="Post" required="true" />
